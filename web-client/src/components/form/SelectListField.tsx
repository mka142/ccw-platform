          ...
          <div className="min-w-max">
            ...
            <div className="flex gap-3 mb-4">
              {options.map((option, optIndex) => (
                <div key={optIndex} className="text-xs font-medium text-gray-600 w-16 text-center flex-shrink-0">
                  {option}
                </div>
              ))}
            </div>
            ...
            <div className="space-y-4">
              {items.map((item, index) => (
                <div key={index} className="flex gap-3">
                  {options.map((option, optIndex) => (
                    <div key={optIndex} className="w-16 flex justify-center flex-shrink-0">
